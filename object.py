...
class object:
    ...
    match_thresholds=np.array([0.5,1.00,0.60])  # dummy value for matching threshold 
    ...
    @classmethod
    def initialize_object_parameters(cls,match_threshold):
        cls.match_thresholds=match_threshold   # to update/initialize the threshold limit of object class
